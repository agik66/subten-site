...
window.SUBTEN_I18N = {
  ...
  "coach.privacy": { sk: "<strong>AI priamo v tvojom iPhone.</strong> Po prvom stiahnutí modelu (na Wi-Fi) bežia rozhovory s trénerom aj denné a týždenné vyhodnotenia lokálne na zariadení — tvoje zdravotné dáta ho neopúšťajú a coach funguje aj offline. Platí pre novšie iPhony; na starších zariadeniach a pri funkciách s fotkou (sken jedla, posúdenie postavy) sa dáta spracúvajú v cloude — vždy len s tvojím výslovným súhlasom.", en: "<strong>AI right on your iPhone.</strong> After a one-time model download (on Wi-Fi), coach conversations and your daily and weekly reviews run locally on the device — your health data never leaves it, and the coach even works offline. Applies to newer iPhones; on older devices and for photo features (food scan, body assessment) data is processed in the cloud — always only with your explicit consent.", cz: "<strong>AI přímo ve tvém iPhonu.</strong> Po prvním stažení modelu (na Wi-Fi) běží rozhovory s trenérem i denní a týdenní vyhodnocení lokálně na zařízení — tvoje zdravotní data ho neopouštějí a coach funguje i offline. Platí pro novější iPhony; na starších zařízeních a u funkcí s fotkou (sken jídla, posouzení postavy) se data zpracovávají v cloudu — vždy jen s tvým výslovným souhlasem." },
  ...
  "faq.a4": { sk: "Tvoje zdravotné dáta zostávajú tvoje. AI tréner beží na novších iPhonoch priamo v zariadení — po stiahnutí modelu tvoje zdravotné dáta telefón neopúšťajú. Do cloudu idú len funkcie s fotkou (sken jedla, posúdenie postavy) a AI na starších zariadeniach — vždy s tvojím výslovným súhlasom. Nič nepredávame a účet aj dáta môžeš kedykoľvek vymazať.", en: "Your health data stays yours. On newer iPhones the AI coach runs directly on the device — after the model download your health data never leaves your phone. Only photo features (food scan, body assessment) and AI on older devices use the cloud — always with your explicit consent. We never sell anything, and you can delete your account and data anytime.", cz: "Tvoje zdravotní data zůstávají tvoje. AI trenér běží na novějších iPhonech přímo v zařízení — po stažení modelu tvoje zdravotní data telefon neopouštějí. Do cloudu jdou jen funkce s fotkou (sken jídla, posouzení postavy) a AI na starších zařízeních — vždy s tvým výslovným souhlasem. Nic neprodáváme a účet i data můžeš kdykoli smazat." },
