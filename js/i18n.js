...
window.SUBTEN_I18N = {
  ...
  "faq.a4": { sk: "Tvoje zdravotné dáta zostávajú tvoje. Nepredávame ich a používame ich len na to, aby appka fungovala. Účet aj dáta môžeš kedykoľvek vymazať.", en: "Your health data stays yours. We never sell it and use it only to make the app work. You can delete your account and data anytime.", cz: "Tvoje zdravotní data zůstávají tvoje. Neprodáváme je a používáme je jen k tomu, aby appka fungovala. Účet i data můžeš kdykoli smazat." },
